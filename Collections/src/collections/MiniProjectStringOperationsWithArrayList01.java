...
public class MiniProjectStringOperationsWithArrayList01 {
    ...
    public static ArrayList<String> performStringOperations(String s1, String s2) {
        ...
        // 2. Last occurrence replace or s1 + s2
        ...
        // 3. Delete first occurrence or return s1
        ...
        // 4. Split s2 into two halves and add to s1
